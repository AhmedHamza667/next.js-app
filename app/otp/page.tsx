...
function OTP() {
  ...
  const [resend_OTP, { data: resendData, loading: resendLoading, error: resendError }] = useLazyQuery(resendOTPQuery);
    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="w-4/12 bg-white rounded-lg p-7 text-black">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Link className="flex justify-center" href="#" variant="body2" color="textSecondary" my={2}
